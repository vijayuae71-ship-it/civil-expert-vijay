...
exports.handler = async (event) => {
  ...
  try {
    ...
    const quoteModeInstruction = quoteReady === true
      ? "\n\nQUOTE-READY MODE IS SELECTED. For construction materials, BOQs, cost, quote, budget, estimate, and rate-analysis requests, provide a compact shareable quotation only: **Scope**, **Assumptions**, one itemised Markdown BOQ table, section subtotals where applicable, **Grand Total** or range, **Rate basis**, **Exclusions**, and **Validity / Next Step**. Do not include teaching background, alternatives, or extended reasoning. Keep it concise and do not invent CPWD entries or call preliminary market rates CPWD rates."
      : "";
